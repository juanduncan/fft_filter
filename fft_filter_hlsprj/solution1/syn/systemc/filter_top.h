...
struct filter_top : public sc_module {
    ...
    sc_out< sc_lv<11> > out_r_address1;
    ...
    sc_signal< sc_lv<11> > filter_top_dummy_proc_fe_U0_in_r_address0;
    sc_signal< sc_logic > filter_top_dummy_proc_fe_U0_in_r_ce0;
    sc_signal< sc_lv<64> > filter_top_dummy_proc_fe_U0_in_r_q0;
    ...
    sc_signal< sc_lv<11> > filter_top_dummy_proc_be_U0_out_r_address0;
    sc_signal< sc_logic > filter_top_dummy_proc_be_U0_out_r_ce0;
    sc_signal< sc_logic > filter_top_dummy_proc_be_U0_out_r_we0;
    sc_signal< sc_lv<64> > filter_top_dummy_proc_be_U0_out_r_d0;
    ...
    void thread_filter_top_dummy_proc_fe_U0_in_r_q0();
