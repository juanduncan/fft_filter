; ModuleID = '/home/commlab/Documents/VIVADO_projects/fft_filter/fft_filter_hlsprj/solution1/.autopilot/db/a.o.3.bc'
target datalayout = "e-p:64:64:64-i1:8:8-i8:8:8-i16:16:16-i32:32:32-i64:64:64-f32:32:32-f64:64:64-v64:64:64-v128:128:128-a0:0:64-s0:64:64-f80:128:128-n8:16:32:64-S128"
target triple = "x86_64-unknown-linux-gnu"

@p_str = private unnamed_addr constant [1 x i8] zeroinitializer, align 1 ; [#uses=69 type=[1 x i8]*]
@p_str1 = private unnamed_addr constant [12 x i8] c"RAM_1P_BRAM\00", align 1 ; [#uses=2 type=[12 x i8]*]
@p_str2 = private unnamed_addr constant [12 x i8] c"ROM_1P_BRAM\00", align 1 ; [#uses=4 type=[12 x i8]*]
@p_str3 = private unnamed_addr constant [10 x i8] c"ap_memory\00", align 1 ; [#uses=2 type=[10 x i8]*]
...
@p_str5 = private unnamed_addr constant [11 x i8] c"Vivado_FFT\00", align 1 ; [#uses=2 type=[11 x i8]*]
@p_str6 = private unnamed_addr constant [16 x i8] c"parameterizable\00", align 1 ; [#uses=2 type=[16 x i8]*]
@p_str7 = private unnamed_addr constant [8 x i8] c"ap_fifo\00", align 1 ; [#uses=8 type=[8 x i8]*]
@p_str8 = private unnamed_addr constant [9 x i8] c"channels\00", align 1 ; [#uses=2 type=[9 x i8]*]
@p_str9 = private unnamed_addr constant [17 x i8] c"transform_length\00", align 1 ; [#uses=2 type=[17 x i8]*]
@p_str10 = private unnamed_addr constant [23 x i8] c"implementation_options\00", align 1 ; [#uses=2 type=[23 x i8]*]
@p_str11 = private unnamed_addr constant [39 x i8] c"run_time_configurable_transform_length\00", align 1 ; [#uses=2 type=[39 x i8]*]
@p_str12 = private unnamed_addr constant [12 x i8] c"data_format\00", align 1 ; [#uses=2 type=[12 x i8]*]
@p_str13 = private unnamed_addr constant [12 x i8] c"input_width\00", align 1 ; [#uses=2 type=[12 x i8]*]
@p_str14 = private unnamed_addr constant [13 x i8] c"output_width\00", align 1 ; [#uses=2 type=[13 x i8]*]
@p_str15 = private unnamed_addr constant [19 x i8] c"phase_factor_width\00", align 1 ; [#uses=2 type=[19 x i8]*]
@p_str16 = private unnamed_addr constant [16 x i8] c"scaling_options\00", align 1 ; [#uses=2 type=[16 x i8]*]
@p_str17 = private unnamed_addr constant [15 x i8] c"rounding_modes\00", align 1 ; [#uses=2 type=[15 x i8]*]
@p_str18 = private unnamed_addr constant [7 x i8] c"aclken\00", align 1 ; [#uses=2 type=[7 x i8]*]
@p_str19 = private unnamed_addr constant [5 x i8] c"true\00", align 1 ; [#uses=4 type=[5 x i8]*]
@p_str20 = private unnamed_addr constant [8 x i8] c"aresetn\00", align 1 ; [#uses=2 type=[8 x i8]*]
@p_str21 = private unnamed_addr constant [6 x i8] c"ovflo\00", align 1 ; [#uses=2 type=[6 x i8]*]
@p_str22 = private unnamed_addr constant [9 x i8] c"xk_index\00", align 1 ; [#uses=2 type=[9 x i8]*]
@p_str23 = private unnamed_addr constant [16 x i8] c"throttle_scheme\00", align 1 ; [#uses=2 type=[16 x i8]*]
@p_str24 = private unnamed_addr constant [12 x i8] c"nonrealtime\00", align 1 ; [#uses=2 type=[12 x i8]*]
@p_str25 = private unnamed_addr constant [16 x i8] c"output_ordering\00", align 1 ; [#uses=2 type=[16 x i8]*]
@p_str26 = private unnamed_addr constant [24 x i8] c"cyclic_prefix_insertion\00", align 1 ; [#uses=2 type=[24 x i8]*]
@p_str27 = private unnamed_addr constant [20 x i8] c"memory_options_data\00", align 1 ; [#uses=2 type=[20 x i8]*]
@p_str28 = private unnamed_addr constant [29 x i8] c"memory_options_phase_factors\00", align 1 ; [#uses=2 type=[29 x i8]*]
@p_str29 = private unnamed_addr constant [23 x i8] c"memory_options_reorder\00", align 1 ; [#uses=2 type=[23 x i8]*]
@p_str30 = private unnamed_addr constant [60 x i8] c"number_of_stages_using_block_ram_for_data_and_phase_factors\00", align 1 ; [#uses=2 type=[60 x i8]*]
@p_str31 = private unnamed_addr constant [22 x i8] c"memory_options_hybrid\00", align 1 ; [#uses=2 type=[22 x i8]*]
@p_str32 = private unnamed_addr constant [18 x i8] c"complex_mult_type\00", align 1 ; [#uses=2 type=[18 x i8]*]
@p_str33 = private unnamed_addr constant [15 x i8] c"butterfly_type\00", align 1 ; [#uses=2 type=[15 x i8]*]
@p_str34 = private unnamed_addr constant [12 x i8] c"fixed_point\00", align 1 ; [#uses=2 type=[12 x i8]*]
...
; [#uses=0]
define void @filter_top([2048 x i64]* %coefs, [1536 x i64]* %in, [2048 x i64]* %inxn2, [2048 x i64]* %outxk1, [1536 x i64]* %out) {
.preheader51.preheader:
  ...
  call void (...)* @_ssdm_op_SpecDataflowPipeline(i32 -1, [1 x i8]* @p_str) nounwind, !dbg !7 ; [debug line = 51:1]
  call void (...)* @_ssdm_op_SpecBitsMap([2048 x i64]* %coefs), !map !442
  call void (...)* @_ssdm_op_SpecBitsMap([2048 x i64]* %inxn2), !map !451
  call void (...)* @_ssdm_op_SpecBitsMap([2048 x i64]* %outxk1), !map !458
  call void (...)* @_ssdm_op_SpecBitsMap([1536 x i64]* %in), !map !465
  call void (...)* @_ssdm_op_SpecBitsMap([1536 x i64]* %out), !map !474
  ...
  call void (...)* @_ssdm_op_SpecMemCore([2048 x i64]* %outxk1, [1 x i8]* @p_str, [12 x i8]* @p_str1, [1 x i8]* @p_str, i32 -1, [1 x i8]* @p_str, [1 x i8]* @p_str, [1 x i8]* @p_str)
  call void (...)* @_ssdm_op_SpecMemCore([2048 x i64]* %inxn2, [1 x i8]* @p_str, [12 x i8]* @p_str2, [1 x i8]* @p_str, i32 -1, [1 x i8]* @p_str, [1 x i8]* @p_str, [1 x i8]* @p_str)
  call void (...)* @_ssdm_op_SpecInterface([2048 x i64]* %inxn2, [10 x i8]* @p_str3, i32 0, i32 0, i32 0, i32 0, [1 x i8]* @p_str, [1 x i8]* @p_str, [1 x i8]* @p_str) nounwind
  call void (...)* @_ssdm_op_SpecMemCore([2048 x i64]* %coefs, [1 x i8]* @p_str, [12 x i8]* @p_str2, [1 x i8]* @p_str, i32 -1, [1 x i8]* @p_str, [1 x i8]* @p_str, [1 x i8]* @p_str)
  call void @llvm.dbg.value(metadata !{[2048 x i64]* %coefs}, i64 0, metadata !481), !dbg !496 ; [debug line = 36:28] [debug variable = coefs]
  call void @llvm.dbg.value(metadata !{[1536 x i64]* %in}, i64 0, metadata !497), !dbg !504 ; [debug line = 37:16] [debug variable = in]
  ...
  call void @llvm.dbg.value(metadata !{[1536 x i64]* %out}, i64 0, metadata !515), !dbg !519 ; [debug line = 40:17] [debug variable = out]
  ...
  call fastcc void @filter_top_dummy_proc_fe(i16* %fft_config_fwd_data_V, i16* %fft_config_inv_data_V, [1536 x i64]* %in, [2048 x i64]* %inxn2, i64* %xn_channel, i64* %xn2_channel)
  %empty = call i32 (...)* @_ssdm_op_SpecChannel([30 x i8]* @str61, i32 1, [1 x i8]* @str62, [1 x i8]* @str62, i32 1, i32 0, i16* %fft_config_fwd_data_V, i16* %fft_config_fwd_data_V) ; [#uses=0 type=i32]
  ...
  %empty_17 = call i32 (...)* @_ssdm_op_SpecChannel([3 x i8]* @str67, i32 1, [1 x i8]* @str68, [1 x i8]* @str68, i32 1344, i32 2048, i64* %xn_channel, i64* %xn_channel) ; [#uses=0 type=i32]
  ...
  %empty_18 = call i32 (...)* @_ssdm_op_SpecChannel([30 x i8]* @str64, i32 1, [1 x i8]* @str65, [1 x i8]* @str65, i32 1, i32 0, i16* %fft_config_inv_data_V, i16* %fft_config_inv_data_V) ; [#uses=0 type=i32]
  ...
  %empty_19 = call i32 (...)* @_ssdm_op_SpecChannel([4 x i8]* @str70, i32 1, [1 x i8]* @str71, [1 x i8]* @str71, i32 64, i32 2048, i64* %xn2_channel, i64* %xn2_channel) ; [#uses=0 type=i32]
  ...
  %empty_20 = call i32 (...)* @_ssdm_op_SpecChannel([3 x i8]* @str73, i32 1, [1 x i8]* @str74, [1 x i8]* @str74, i32 64, i32 2048, i64* %xk_channel, i64* %xk_channel) ; [#uses=0 type=i32]
  ...
  %empty_21 = call i32 (...)* @_ssdm_op_SpecChannel([4 x i8]* @str76, i32 1, [1 x i8]* @str77, [1 x i8]* @str77, i32 64, i32 2048, i64* %xk2_channel, i64* %xk2_channel) ; [#uses=0 type=i32]
  ...
  call fastcc void @filter_top_dummy_proc_be([2048 x i64]* %coefs, i64* %xk_channel, i64* %xk2_channel, [2048 x i64]* %outxk1, [1536 x i64]* %out)
...
entry:
  ...
  %empty_22 = trunc i16 %empty to i1              ; [#uses=1 type=i1]
  ret i1 %empty_22
}
...
entry:
  ...
  %empty_23 = zext i1 %1 to i12                   ; [#uses=1 type=i12]
  %empty_24 = shl i12 %empty, 1                   ; [#uses=1 type=i12]
  %empty_25 = or i12 %empty_24, %empty_23         ; [#uses=1 type=i12]
  ret i12 %empty_25
}
...
entry:
  %empty = call i16 @llvm.part.select.i16(i16 %0, i32 %1, i32 %2) ; [#uses=1 type=i16]
  %empty_26 = trunc i16 %empty to i11             ; [#uses=1 type=i11]
  ret i11 %empty_26
}
...
entry:
  ...
  %empty_27 = zext i32 %1 to i64                  ; [#uses=1 type=i64]
  %empty_28 = shl i64 %empty, 32                  ; [#uses=1 type=i64]
...
_ZN3hls6ip_fft8config_tI7config2E6getSchEj.exit.i:
  ...
  call void (...)* @_ssdm_op_SpecIPCore(i32 0, [1 x i8]* @p_str, [11 x i8]* @p_str5, [1 x i8]* @p_str, i32 -1, [1 x i8]* @p_str, [1 x i8]* @p_str, [16 x i8]* @p_str6), !dbg !1927 ; [debug line = 916:1]
  call void (...)* @_ssdm_op_SpecInterface(i16* %config_ch_data_V, [8 x i8]* @p_str7, i32 0, i32 0, i32 0, i32 0, [1 x i8]* @p_str, [1 x i8]* @p_str, [1 x i8]* @p_str) nounwind, !dbg !1929 ; [debug line = 918:1]
  call void (...)* @_ssdm_op_SpecInterface(i8* %status_data_V, [8 x i8]* @p_str7, i32 0, i32 0, i32 0, i32 0, [1 x i8]* @p_str, [1 x i8]* @p_str, [1 x i8]* @p_str) nounwind, !dbg !1930 ; [debug line = 919:1]
  call void (...)* @_ssdm_op_SpecInterface(i64* %xn, [8 x i8]* @p_str7, i32 0, i32 0, i32 0, i32 0, [1 x i8]* @p_str, [1 x i8]* @p_str, [1 x i8]* @p_str)
  call void (...)* @_ssdm_op_SpecInterface(i64* %xk, [8 x i8]* @p_str7, i32 0, i32 0, i32 0, i32 0, [1 x i8]* @p_str, [1 x i8]* @p_str, [1 x i8]* @p_str)
...
; [#uses=1]
define internal fastcc void @filter_top_dummy_proc_fe(i16* %config_fwd_data_V, i16* %config_inv_data_V, [1536 x i64]* nocapture %in, [2048 x i64]* %input_xn2, i64* %output_xn1, i64* %output_xn2) {
_ZN3hls6ip_fft8config_tI7config1E6setSchEjj.exit:
  ...
  call void (...)* @_ssdm_op_SpecMemCore([2048 x i64]* %input_xn2, [1 x i8]* @p_str, [12 x i8]* @p_str2, [1 x i8]* @p_str, i32 -1, [1 x i8]* @p_str, [1 x i8]* @p_str, [1 x i8]* @p_str)
  call void (...)* @_ssdm_op_SpecInterface([2048 x i64]* %input_xn2, [10 x i8]* @p_str3, i32 0, i32 0, i32 0, i32 0, [1 x i8]* @p_str, [1 x i8]* @p_str, [1 x i8]* @p_str) nounwind
  ...
  call void @llvm.dbg.value(metadata !{[1536 x i64]* %in}, i64 0, metadata !2026), !dbg !2030 ; [debug line = 3:42] [debug variable = in]
...
; <label>:0                                       ; preds = %5, %_ZN3hls6ip_fft8config_tI7config1E6setSchEjj.exit
  %i = phi i12 [ 0, %_ZN3hls6ip_fft8config_tI7config1E6setSchEjj.exit ], [ %i_1, %5 ] ; [#uses=7 type=i12]
...
; <label>:3                                       ; preds = %1
  %tmp_5 = trunc i12 %i to i11, !dbg !2094        ; [#uses=1 type=i11] [debug line = 10:10]
  %tmp_2 = add i11 %tmp_5, -512, !dbg !2107       ; [#uses=1 type=i11] [debug line = 15:7]
  %tmp_3 = zext i11 %tmp_2 to i64, !dbg !2107     ; [#uses=1 type=i64] [debug line = 15:7]
  %in_addr = getelementptr [1536 x i64]* %in, i64 0, i64 %tmp_3, !dbg !2109 ; [#uses=1 type=i64*] [debug line = 382:9@123:12@15:7]
  %in_load = load i64* %in_addr, align 8, !dbg !2109 ; [#uses=3 type=i64] [debug line = 382:9@123:12@15:7]
  %tmp_7 = trunc i64 %in_load to i32, !dbg !2109  ; [#uses=1 type=i32] [debug line = 382:9@123:12@15:7]
  %in_M_imag_V_load_new = call i32 @_ssdm_op_PartSelect.i32.i64.i32.i32(i64 %in_load, i32 32, i32 63), !dbg !2109 ; [#uses=1 type=i32] [debug line = 382:9@123:12@15:7]
  call void @_ssdm_op_Write.ap_fifo.volatile.i64P(i64* %output_xn1, i64 %in_load), !dbg !2109 ; [debug line = 382:9@123:12@15:7]
...
; <label>:4                                       ; preds = %3
  %tmp_8 = trunc i12 %i to i9, !dbg !2094         ; [#uses=1 type=i9] [debug line = 10:10]
  %tmp_6 = zext i9 %tmp_8 to i64, !dbg !2112      ; [#uses=2 type=i64] [debug line = 17:8]
  ...
  store i32 %tmp_7, i32* %detector_tail_M_real_V_addr_1, align 4, !dbg !2113 ; [debug line = 382:9@123:12@17:8]
...
_ZN3hls6ip_fft8config_tI7config1E6getSchEj.exit.i:
  ...
  call void (...)* @_ssdm_op_SpecIPCore(i32 0, [1 x i8]* @p_str, [11 x i8]* @p_str5, [1 x i8]* @p_str, i32 -1, [1 x i8]* @p_str, [1 x i8]* @p_str, [16 x i8]* @p_str6), !dbg !2138 ; [debug line = 916:1]
  call void (...)* @_ssdm_op_SpecInterface(i16* %config_ch_data_V, [8 x i8]* @p_str7, i32 0, i32 0, i32 0, i32 0, [1 x i8]* @p_str, [1 x i8]* @p_str, [1 x i8]* @p_str) nounwind, !dbg !2140 ; [debug line = 918:1]
  call void (...)* @_ssdm_op_SpecInterface(i8* %status_data_V, [8 x i8]* @p_str7, i32 0, i32 0, i32 0, i32 0, [1 x i8]* @p_str, [1 x i8]* @p_str, [1 x i8]* @p_str) nounwind, !dbg !2141 ; [debug line = 919:1]
  call void (...)* @_ssdm_op_SpecInterface(i64* %xn, [8 x i8]* @p_str7, i32 0, i32 0, i32 0, i32 0, [1 x i8]* @p_str, [1 x i8]* @p_str, [1 x i8]* @p_str)
  call void (...)* @_ssdm_op_SpecInterface(i64* %xk, [8 x i8]* @p_str7, i32 0, i32 0, i32 0, i32 0, [1 x i8]* @p_str, [1 x i8]* @p_str, [1 x i8]* @p_str)
...
; [#uses=1]
define internal fastcc void @filter_top_dummy_proc_be([2048 x i64]* %coefs, i64* %input_xk1, i64* %input_xk2, [2048 x i64]* %output_xk1, [1536 x i64]* nocapture %out) {
  ...
  call void (...)* @_ssdm_op_SpecMemCore([2048 x i64]* %output_xk1, [1 x i8]* @p_str, [12 x i8]* @p_str1, [1 x i8]* @p_str, i32 -1, [1 x i8]* @p_str, [1 x i8]* @p_str, [1 x i8]* @p_str)
  call void (...)* @_ssdm_op_SpecMemCore([2048 x i64]* %coefs, [1 x i8]* @p_str, [12 x i8]* @p_str2, [1 x i8]* @p_str, i32 -1, [1 x i8]* @p_str, [1 x i8]* @p_str, [1 x i8]* @p_str)
  ...
  call void @llvm.dbg.value(metadata !{[1536 x i64]* %out}, i64 0, metadata !2218), !dbg !2222 ; [debug line = 23:79] [debug variable = out]
  br label %1, !dbg !2223                         ; [debug line = 25:10]

; <label>:1                                       ; preds = %5, %0
  %i = phi i12 [ 0, %0 ], [ %i_1, %5 ]            ; [#uses=5 type=i12]
  ...
  br i1 %exitcond, label %6, label %2, !dbg !2223 ; [debug line = 25:10]
...
; <label>:2                                       ; preds = %1
  ...
  %tmp_10 = trunc i64 %coefs_load to i32, !dbg !2229 ; [#uses=1 type=i32] [debug line = 26:34]
  ...
  %tmp_11 = trunc i64 %input_xk1_read to i32, !dbg !2229 ; [#uses=1 type=i32] [debug line = 26:34]
  ...
  call void @llvm.dbg.value(metadata !{i32 %tmp_11}, i64 0, metadata !2230), !dbg !2236 ; [debug line = 380:35@26:34] [debug variable = __x._M_real.V]
  ...
  call void @llvm.dbg.value(metadata !{i32 %tmp_10}, i64 0, metadata !2238), !dbg !2240 ; [debug line = 380:60@26:34] [debug variable = __y._M_real.V]
  ...
  call void @llvm.dbg.value(metadata !{i32 %tmp_10}, i64 0, metadata !2242), !dbg !2248 ; [debug line = 214:53@383:7@26:34] [debug variable = __z._M_real.V]
  ...
  call void @llvm.dbg.value(metadata !{i32 %tmp_10}, i64 0, metadata !2250), !dbg !2258 ; [debug line = 155:7@295:33@383:7@26:34] [debug variable = complex<ap_fixed<32, 1, 5, 3, 0> >._M_real.V]
  ...
  %tmp_1 = sext i32 %tmp_10 to i63, !dbg !2260    ; [#uses=2 type=i63] [debug line = 1296:9@295:33@383:7@26:34]
  %tmp_2 = sext i32 %tmp_11 to i63, !dbg !2260    ; [#uses=2 type=i63] [debug line = 1296:9@295:33@383:7@26:34]
  call void @llvm.dbg.value(metadata !{i32 %tmp_10}, i64 0, metadata !2815), !dbg !2820 ; [debug line = 163:7@295:56@383:7@26:34] [debug variable = complex<ap_fixed<32, 1, 5, 3, 0> >._M_real.V]
  ...
  call void @llvm.dbg.value(metadata !{i32 %tmp_10}, i64 0, metadata !2847), !dbg !2851 ; [debug line = 163:7@296:27@383:7@26:34] [debug variable = complex<ap_fixed<32, 1, 5, 3, 0> >._M_real.V]
  ...
  call void @llvm.dbg.value(metadata !{i32 %tmp_10}, i64 0, metadata !2853), !dbg !2857 ; [debug line = 155:7@296:50@383:7@26:34] [debug variable = complex<ap_fixed<32, 1, 5, 3, 0> >._M_real.V]
  ...
  %tmp_12 = call i3 @_ssdm_op_PartSelect.i3.i12.i32.i32(i12 %i, i32 9, i32 11), !dbg !2881 ; [#uses=1 type=i3] [debug line = 27:6]
  %icmp = icmp eq i3 %tmp_12, 0, !dbg !2881       ; [#uses=1 type=i1] [debug line = 27:6]
  br i1 %icmp, label %3, label %4, !dbg !2881     ; [debug line = 27:6]

; <label>:3                                       ; preds = %2
  %input_xk2_load = call i64 @_ssdm_op_Read.ap_fifo.volatile.i64P(i64* %input_xk2), !dbg !2882 ; [#uses=0 type=i64] [debug line = 382:9@123:12@28:7]
  br label %5, !dbg !2886                         ; [debug line = 29:6]

; <label>:4                                       ; preds = %2
  %tmp_13 = trunc i12 %i to i11, !dbg !2223       ; [#uses=1 type=i11] [debug line = 25:10]
  %tmp_9 = add i11 %tmp_13, -512, !dbg !2887      ; [#uses=1 type=i11] [debug line = 30:7]
  %tmp_s = zext i11 %tmp_9 to i64, !dbg !2887     ; [#uses=1 type=i64] [debug line = 30:7]
  %input_xk2_read = call i64 @_ssdm_op_Read.ap_fifo.volatile.i64P(i64* %input_xk2), !dbg !2889 ; [#uses=1 type=i64] [debug line = 382:9@123:12@30:7]
  %out_addr = getelementptr [1536 x i64]* %out, i64 0, i64 %tmp_s, !dbg !2889 ; [#uses=1 type=i64*] [debug line = 382:9@123:12@30:7]
  store i64 %input_xk2_read, i64* %out_addr, align 8, !dbg !2889 ; [debug line = 382:9@123:12@30:7]
  br label %5

; <label>:5                                       ; preds = %4, %3
  call void @llvm.dbg.value(metadata !{i12 %i_1}, i64 0, metadata !2891), !dbg !2226 ; [debug line = 25:30] [debug variable = i]
  br label %1, !dbg !2226                         ; [debug line = 25:30]

; <label>:6                                       ; preds = %1
  ret void, !dbg !2892                            ; [debug line = 34:1]
}
...
!451 = metadata !{metadata !452, metadata !455}
!452 = metadata !{i32 0, i32 31, metadata !453}
!453 = metadata !{metadata !454}
!454 = metadata !{metadata !"inxn2._M_real.V", metadata !446, metadata !"int32", i32 0, i32 31}
!455 = metadata !{i32 32, i32 63, metadata !456}
!456 = metadata !{metadata !457}
!457 = metadata !{metadata !"inxn2._M_imag.V", metadata !446, metadata !"int32", i32 0, i32 31}
!458 = metadata !{metadata !459, metadata !462}
!459 = metadata !{i32 0, i32 31, metadata !460}
!460 = metadata !{metadata !461}
!461 = metadata !{metadata !"outxk1._M_real.V", metadata !446, metadata !"int32", i32 0, i32 31}
!462 = metadata !{i32 32, i32 63, metadata !463}
!463 = metadata !{metadata !464}
!464 = metadata !{metadata !"outxk1._M_imag.V", metadata !446, metadata !"int32", i32 0, i32 31}
!465 = metadata !{metadata !466, metadata !471}
!466 = metadata !{i32 0, i32 31, metadata !467}
!467 = metadata !{metadata !468}
!468 = metadata !{metadata !"in._M_real.V", metadata !469, metadata !"int32", i32 0, i32 31}
!469 = metadata !{metadata !470}
!470 = metadata !{i32 0, i32 1535, i32 1}
!471 = metadata !{i32 32, i32 63, metadata !472}
!472 = metadata !{metadata !473}
!473 = metadata !{metadata !"in._M_imag.V", metadata !469, metadata !"int32", i32 0, i32 31}
!474 = metadata !{metadata !475, metadata !478}
!475 = metadata !{i32 0, i32 31, metadata !476}
!476 = metadata !{metadata !477}
!477 = metadata !{metadata !"out._M_real.V", metadata !469, metadata !"int32", i32 0, i32 31}
!478 = metadata !{i32 32, i32 63, metadata !479}
!479 = metadata !{metadata !480}
!480 = metadata !{metadata !"out._M_imag.V", metadata !469, metadata !"int32", i32 0, i32 31}
...
!2107 = metadata !{i32 15, i32 7, metadata !2108, null}
!2108 = metadata !{i32 786443, metadata !2098, i32 14, i32 11, metadata !10, i32 4} ; [ DW_TAG_lexical_block ]
!2109 = metadata !{i32 382, i32 9, metadata !1992, metadata !2110}
!2110 = metadata !{i32 123, i32 12, metadata !1995, metadata !2107}
!2111 = metadata !{i32 16, i32 7, metadata !2108, null}
!2112 = metadata !{i32 17, i32 8, metadata !2108, null}
...
!2886 = metadata !{i32 29, i32 6, metadata !2885, null}
!2887 = metadata !{i32 30, i32 7, metadata !2888, null}
!2888 = metadata !{i32 786443, metadata !2228, i32 29, i32 11, metadata !10, i32 9} ; [ DW_TAG_lexical_block ]
!2889 = metadata !{i32 382, i32 9, metadata !1992, metadata !2890}
!2890 = metadata !{i32 123, i32 12, metadata !1995, metadata !2887}
!2891 = metadata !{i32 786688, metadata !2225, metadata !"i", metadata !10, i32 24, metadata !41, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!2892 = metadata !{i32 34, i32 1, metadata !2225, null}
