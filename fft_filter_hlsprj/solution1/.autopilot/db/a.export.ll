; ModuleID = '/home/commlab/Documents/VIVADO_projects/fft_filter/fft_filter_hlsprj/solution1/.autopilot/db/a.o.2.bc'
...
@p_str2 = private unnamed_addr constant [12 x i8] c"ROM_1P_BRAM\00", align 1
...
@p_str5 = private unnamed_addr constant [11 x i8] c"Vivado_FFT\00", align 1
@p_str6 = private unnamed_addr constant [16 x i8] c"parameterizable\00", align 1
...
define void @filter_top([2048 x i64]* %coefs, [1536 x i64]* %in_r, [2048 x i64]* %inxn2, [2048 x i64]* %outxk1, [1536 x i64]* %out_r) {
.preheader51.preheader:
  ...
  call void (...)* @_ssdm_op_SpecBitsMap([2048 x i64]* %coefs), !map !7
  call void (...)* @_ssdm_op_SpecBitsMap([2048 x i64]* %inxn2), !map !16
  call void (...)* @_ssdm_op_SpecBitsMap([2048 x i64]* %outxk1), !map !23
  call void (...)* @_ssdm_op_SpecBitsMap([1536 x i64]* %in_r), !map !30
  call void (...)* @_ssdm_op_SpecBitsMap([1536 x i64]* %out_r), !map !39
  ...
  call fastcc void @filter_top_dummy_proc_fe(i16* %fft_config_fwd_data_V, i16* %fft_config_inv_data_V, [1536 x i64]* %in_r, [2048 x i64]* %inxn2, i64* %xn_channel, i64* %xn2_channel)
  %empty = call i32 (...)* @_ssdm_op_SpecChannel([30 x i8]* @str61, i32 1, [1 x i8]* @str62, [1 x i8]* @str62, i32 1, i32 0, i16* %fft_config_fwd_data_V, i16* %fft_config_fwd_data_V)
  ...
  %empty_17 = call i32 (...)* @_ssdm_op_SpecChannel([3 x i8]* @str67, i32 1, [1 x i8]* @str68, [1 x i8]* @str68, i32 1344, i32 2048, i64* %xn_channel, i64* %xn_channel)
  ...
  %empty_18 = call i32 (...)* @_ssdm_op_SpecChannel([30 x i8]* @str64, i32 1, [1 x i8]* @str65, [1 x i8]* @str65, i32 1, i32 0, i16* %fft_config_inv_data_V, i16* %fft_config_inv_data_V)
  ...
  %empty_19 = call i32 (...)* @_ssdm_op_SpecChannel([4 x i8]* @str70, i32 1, [1 x i8]* @str71, [1 x i8]* @str71, i32 64, i32 2048, i64* %xn2_channel, i64* %xn2_channel)
  ...
  %empty_20 = call i32 (...)* @_ssdm_op_SpecChannel([3 x i8]* @str73, i32 1, [1 x i8]* @str74, [1 x i8]* @str74, i32 64, i32 2048, i64* %xk_channel, i64* %xk_channel)
  ...
  %empty_21 = call i32 (...)* @_ssdm_op_SpecChannel([4 x i8]* @str76, i32 1, [1 x i8]* @str77, [1 x i8]* @str77, i32 64, i32 2048, i64* %xk2_channel, i64* %xk2_channel)
  ...
  call fastcc void @filter_top_dummy_proc_be([2048 x i64]* %coefs, i64* %xk_channel, i64* %xk2_channel, [2048 x i64]* %outxk1, [1536 x i64]* %out_r)
  ret void
}
...
entry:
  ...
  %empty_22 = trunc i16 %empty to i1
  ret i1 %empty_22
}
...
entry:
  ...
  %empty_23 = zext i1 %1 to i12
  %empty_24 = shl i12 %empty, 1
  %empty_25 = or i12 %empty_24, %empty_23
  ret i12 %empty_25
}
...
entry:
  %empty = call i16 @llvm.part.select.i16(i16 %0, i32 %1, i32 %2)
  %empty_26 = trunc i16 %empty to i11
  ret i11 %empty_26
}
...
entry:
  ...
  %empty_27 = zext i32 %1 to i64
  %empty_28 = shl i64 %empty, 32
...
_ZN3hls6ip_fft8config_tI7config2E6getSchEj.exit.i:
  ...
  call void (...)* @_ssdm_op_SpecIPCore(i32 0, [1 x i8]* @p_str, [11 x i8]* @p_str5, [1 x i8]* @p_str, i32 -1, [1 x i8]* @p_str, [1 x i8]* @p_str, [16 x i8]* @p_str6)
  call void (...)* @_ssdm_op_SpecInterface(i16* %config_ch_data_V, [8 x i8]* @p_str7, i32 0, i32 0, i32 0, i32 0, [1 x i8]* @p_str, [1 x i8]* @p_str, [1 x i8]* @p_str) nounwind
  call void (...)* @_ssdm_op_SpecInterface(i8* %status_data_V, [8 x i8]* @p_str7, i32 0, i32 0, i32 0, i32 0, [1 x i8]* @p_str, [1 x i8]* @p_str, [1 x i8]* @p_str) nounwind
...
define internal fastcc void @filter_top_dummy_proc_fe(i16* %config_fwd_data_V, i16* %config_inv_data_V, [1536 x i64]* nocapture %in_r, [2048 x i64]* %input_xn2, i64* %output_xn1, i64* %output_xn2) {
...
; <label>:3                                       ; preds = %1
  %tmp_5 = trunc i12 %i to i11
  %tmp_2 = add i11 %tmp_5, -512
  %tmp_3 = zext i11 %tmp_2 to i64
  %in_addr = getelementptr [1536 x i64]* %in_r, i64 0, i64 %tmp_3
  %in_load = load i64* %in_addr, align 8
  %tmp_7 = trunc i64 %in_load to i32
  %in_M_imag_V_load_new = call i32 @_ssdm_op_PartSelect.i32.i64.i32.i32(i64 %in_load, i32 32, i32 63)
  call void @_ssdm_op_Write.ap_fifo.volatile.i64P(i64* %output_xn1, i64 %in_load)
...
define internal fastcc void @filter_top_dummy_proc_be([2048 x i64]* %coefs, i64* %input_xk1, i64* %input_xk2, [2048 x i64]* %output_xk1, [1536 x i64]* nocapture %out_r) {
...
; <label>:2                                       ; preds = %1
  ...
  %tmp_10 = trunc i64 %coefs_load to i32
  ...
  %tmp_i_cast = mul i63 %tmp_3, %tmp_2
  %tmp_3_i_cast = mul i63 %tmp_1, %tmp_4
  %p_Val2_1 = add i63 %tmp_i_cast, %tmp_3_i_cast
  ...
  %tmp_12 = call i3 @_ssdm_op_PartSelect.i3.i12.i32.i32(i12 %i, i32 9, i32 11)
  %icmp = icmp eq i3 %tmp_12, 0
  br i1 %icmp, label %3, label %4

; <label>:3                                       ; preds = %2
  %input_xk2_load = call i64 @_ssdm_op_Read.ap_fifo.volatile.i64P(i64* %input_xk2)
  br label %5

; <label>:4                                       ; preds = %2
  %tmp_13 = trunc i12 %i to i11
  %tmp_9 = add i11 %tmp_13, -512
  %tmp_s = zext i11 %tmp_9 to i64
  %input_xk2_read = call i64 @_ssdm_op_Read.ap_fifo.volatile.i64P(i64* %input_xk2)
  %out_addr = getelementptr [1536 x i64]* %out_r, i64 0, i64 %tmp_s
  store i64 %input_xk2_read, i64* %out_addr, align 8
  br label %5
...
entry:
  ...
  %empty_31 = trunc i63 %empty to i32
  ret i32 %empty_31
}
...
entry:
  ...
  %empty_32 = trunc i12 %empty to i3
  ret i3 %empty_32
}
...
!10 = metadata !{metadata !"coefs._M_real.V", metadata !11, metadata !"int32", i32 0, i32 31}
!11 = metadata !{metadata !12}
!12 = metadata !{i32 0, i32 2047, i32 1}
!13 = metadata !{i32 32, i32 63, metadata !14}
!14 = metadata !{metadata !15}
!15 = metadata !{metadata !"coefs._M_imag.V", metadata !11, metadata !"int32", i32 0, i32 31}
!16 = metadata !{metadata !17, metadata !20}
!17 = metadata !{i32 0, i32 31, metadata !18}
!18 = metadata !{metadata !19}
!19 = metadata !{metadata !"inxn2._M_real.V", metadata !11, metadata !"int32", i32 0, i32 31}
!20 = metadata !{i32 32, i32 63, metadata !21}
!21 = metadata !{metadata !22}
!22 = metadata !{metadata !"inxn2._M_imag.V", metadata !11, metadata !"int32", i32 0, i32 31}
!23 = metadata !{metadata !24, metadata !27}
!24 = metadata !{i32 0, i32 31, metadata !25}
!25 = metadata !{metadata !26}
!26 = metadata !{metadata !"outxk1._M_real.V", metadata !11, metadata !"int32", i32 0, i32 31}
!27 = metadata !{i32 32, i32 63, metadata !28}
!28 = metadata !{metadata !29}
!29 = metadata !{metadata !"outxk1._M_imag.V", metadata !11, metadata !"int32", i32 0, i32 31}
!30 = metadata !{metadata !31, metadata !36}
!31 = metadata !{i32 0, i32 31, metadata !32}
!32 = metadata !{metadata !33}
!33 = metadata !{metadata !"in._M_real.V", metadata !34, metadata !"int32", i32 0, i32 31}
!34 = metadata !{metadata !35}
!35 = metadata !{i32 0, i32 1535, i32 1}
!36 = metadata !{i32 32, i32 63, metadata !37}
!37 = metadata !{metadata !38}
!38 = metadata !{metadata !"in._M_imag.V", metadata !34, metadata !"int32", i32 0, i32 31}
!39 = metadata !{metadata !40, metadata !43}
!40 = metadata !{i32 0, i32 31, metadata !41}
!41 = metadata !{metadata !42}
!42 = metadata !{metadata !"out._M_real.V", metadata !34, metadata !"int32", i32 0, i32 31}
!43 = metadata !{i32 32, i32 63, metadata !44}
!44 = metadata !{metadata !45}
!45 = metadata !{metadata !"out._M_imag.V", metadata !34, metadata !"int32", i32 0, i32 31}
