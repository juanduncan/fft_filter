...
set C_modelArgMapList {[ 
	{ "Name" : "coefs", "interface" : "memory", "bitwidth" : 64} , 
 	...
 	{ "Name" : "out_r", "interface" : "memory", "bitwidth" : 64} ]}
...
set Spec2ImplPortList { 
	...
	out_r { ap_memory {  { out_r_address0 mem_address 1 11 }  { out_r_ce0 mem_ce 1 1 }  { out_r_we0 mem_we 1 1 }  { out_r_d0 mem_din 1 64 } } }
}
