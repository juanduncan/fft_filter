...
#ifndef __filter_top_mul_32dEe__HH__
#define __filter_top_mul_32dEe__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(filter_top_mul_32dEe) {
    ...
    SC_CTOR(filter_top_mul_32dEe):  ACMP_mul_ss_U ("ACMP_mul_ss_U") {
