...
HD_PWD='/home/commlab/Documents/VIVADO_projects/fft_filter/fft_filter_hlsprj/solution3/impl/vhdl/project.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log filter_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source filter_top.tcl
