; ModuleID = '/home/commlab/Documents/VIVADO_projects/fft_filter/fft_filter_hlsprj/solution4_axi/.autopilot/db/a.o.3.bc'
...
@p_str1 = private unnamed_addr constant [1 x i8] zeroinitializer, align 1 ; [#uses=102 type=[1 x i8]*]
...
.preheader51.preheader:
  ...
  call void (...)* @_ssdm_op_SpecBitsMap([2048 x i64]* %coefs), !map !1101
  call void (...)* @_ssdm_op_SpecBitsMap(i64* %out), !map !1108
  call void (...)* @_ssdm_op_SpecBitsMap([2048 x i64]* %outxk1), !map !1115
  ...
  call void (...)* @_ssdm_op_SpecInterface(i64* %out, [5 x i8]* @p_str3, i32 0, i32 0, i32 0, i32 0, [1 x i8]* @p_str1, [1 x i8]* @p_str1, [1 x i8]* @p_str1)
...
; <label>:3                                       ; preds = %1
  %in_read = call i64 @_ssdm_op_Read.axis.volatile.i64P(i64* %in), !dbg !2733 ; [#uses=3 type=i64] [debug line = 382:9@123:12@16:7]
...
; <label>:3                                       ; preds = %2
  call void @_ssdm_op_Write.axis.volatile.i64P(i64* %out, i64 %input_xk2_read), !dbg !2866 ; [debug line = 382:9@123:12@32:7]
  br label %4
...
!1104 = metadata !{metadata !"coefs._M_real.V", metadata !1096, metadata !"int32", i32 0, i32 31}
!1105 = metadata !{i32 32, i32 63, metadata !1106}
!1106 = metadata !{metadata !1107}
!1107 = metadata !{metadata !"coefs._M_imag.V", metadata !1096, metadata !"int32", i32 0, i32 31}
...
!1118 = metadata !{metadata !"outxk1._M_real.V", metadata !1096, metadata !"int32", i32 0, i32 31}
!1119 = metadata !{i32 32, i32 63, metadata !1120}
!1120 = metadata !{metadata !1121}
!1121 = metadata !{metadata !"outxk1._M_imag.V", metadata !1096, metadata !"int32", i32 0, i32 31}
