; ModuleID = '/home/commlab/Documents/VIVADO_projects/fft_filter/fft_filter_hlsprj/solution5_axi_no_ap_ctrl/.autopilot/db/a.o.2.bc'
...
@p_str2 = private unnamed_addr constant [16 x i8] c"ap_ctrl_ce_only\00", align 1
...
.preheader51.preheader:
  ...
  call void (...)* @_ssdm_op_SpecBitsMap([2048 x i64]* %inxn2), !map !23
  call void (...)* @_ssdm_op_SpecBitsMap(i64* %in_r), !map !30
  ...
  call void (...)* @_ssdm_op_SpecInterface(i32 0, [16 x i8]* @p_str2, i32 0, i32 0, i32 0, i32 0, [1 x i8]* @p_str1, [1 x i8]* @p_str1, [1 x i8]* @p_str1) nounwind
  ...
  call void (...)* @_ssdm_op_SpecInterface(i64* %out_r, [5 x i8]* @p_str4, i32 0, i32 0, i32 0, i32 0, [1 x i8]* @p_str1, [1 x i8]* @p_str1, [1 x i8]* @p_str1)
  call void (...)* @_ssdm_op_SpecInterface(i64* %in_r, [5 x i8]* @p_str4, i32 0, i32 0, i32 0, i32 0, [1 x i8]* @p_str1, [1 x i8]* @p_str1, [1 x i8]* @p_str1)
...
!26 = metadata !{metadata !"inxn2._M_real.V", metadata !11, metadata !"int32", i32 0, i32 31}
!27 = metadata !{i32 32, i32 63, metadata !28}
!28 = metadata !{metadata !29}
!29 = metadata !{metadata !"inxn2._M_imag.V", metadata !11, metadata !"int32", i32 0, i32 31}
